...
export function updateGameState<T extends BaseGameData>(renderGame: (data: T) => void): Promise<T> {
...
export function startNewGame(gameType: string, gameOptions: { player1_type: string, player2_type: string }, renderGame: (data: any) => void): Promise<void> {
